const ProviderApp = ({
  ...
  const getSetupInstructions = roomId => {
    ...
    const link = getInviteUrl(roomId);
    return `You've been invited to securely manage your information on Khora.\n\nTo get started:\n\n1. Create a free account on Element:\n   Go to https://app.element.io/#/register\n   It's free and only takes a minute. Remember your username and password.\n   (Element is also great for direct messaging if you want to chat with people securely.)\n\n2. Come back to Khora and sign in:\n   Go to Khora and sign in with the same username and password you just created.\n   Khora is where you do your case management work — same account, different tools.\n\n3. Accept the room invitation:\n   The invite should appear automatically.\n   You can also open this link: ${link}\n   (Note: this is a private room — the invite must be accepted from the account specified above)\n\n4. You will have full control of this room — you can remove anyone from it at any time.\n\nQuestions? Contact your provider for help getting set up.`;
  };
